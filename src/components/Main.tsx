...
const Main = () => {
  return (
    <div className="mt-20 md:mt-36 lg:mt-64 lg:flex">
      ...
      <div className="flex flex-col items-center justify-center mt-6 md:mt-12 text-green-text-color font-semibold lg:w-[50%]">
